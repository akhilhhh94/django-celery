...
SECRET_KEY = 'django-insecure-x(^iz-zrjx53d$blc5fhh-v=ra40xp7#dilq9h0fogdo5vckq$'
...
CELERY_BROKER_URL = 'redis://127.0.0.1:8888'
CELERY_RESULT_BACKEND = 'redis://127.0.0.1:8888'
